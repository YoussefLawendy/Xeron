    ...
    return (
        <section className="relative h-[800px] md:min-h-screen flex items-center justify-center text-center px-[24px] pt-[40px] md:pt-[112px] pb-[40px] md:pb-[80px] overflow-hidden">
            ...
            <div className="relative z-10 max-w-[1200px] mx-auto">
                <h1 className="font-display text-2xl md:text-[48px] lg:text-[64px] font-extrabold text-content-primary tracking-tight leading-[1.13] mb-[32px] md:mb-[80px] animate-fade-up">
                    We Build Digital Solutions That Drive Business Growth
                </h1>

                <p className="text-sm md:text-[24px] text-[#6F6E7B] leading-[28px] max-w-[1200px] mx-auto mb-[40px] md:mb-[80px] animate-fade-up-2">
