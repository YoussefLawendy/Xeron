...
export default function HeroSection() {
    return (
        <section className="relative min-h-screen flex items-center justify-center text-center px-[24px] pt-[112px] pb-[80px] overflow-hidden">
            ...
            <div className="relative z-10 max-w-[1200px] mx-auto">
                ...
                <div className="flex items-center justify-center gap-[40px] flex-wrap animate-fade-up-3">
