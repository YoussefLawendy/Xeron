...
const gradientRingClass = 'relative inline-flex rounded-full p-[1.5px] bg-gradient-to-br from-purple-200 via-purple-50 to-purple-500 hover:opacity-80 transition-opacity duration-200';
        ...
        <div className="flex flex-col gap-8 pt-2">
            ...
            <div className="flex items-start gap-4">
                ...
                <div className="flex flex-col gap-4">
                    ...
                    <a href="mailto:Youssef@xeron.com" className="text-[16px] font-bold text-purple-50/50 hover:text-purple-50/80 transition-colors duration-200">
                        Youssef@xeron.com
                    </a>
                </div>
            </div>
            ...
            <div className="flex items-start gap-4">
                ...
                <div className="flex flex-col gap-4">
                    ...
                    <a href="tel:+201063361951" className="text-[16px] font-bold text-purple-50/50 hover:text-purple-50/80 transition-colors duration-200">
                        +201063361951
                    </a>
                </div>
            </div>
